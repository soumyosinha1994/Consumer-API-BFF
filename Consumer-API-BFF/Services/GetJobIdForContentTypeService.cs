...
{
    public class GetJobIdForContentTypeService : IGetJobIdForContentTypeService
    {
        private readonly string _connection_ID;
        private readonly string _base_Url;
        private readonly IHttpClientFactory _httpClientFactory;
        public GetJobIdForContentTypeService(IConfiguration configuration, IHttpClientFactory httpClientFactory)
        {
            _connection_ID = configuration["CONNECTION_ID"]!;
            _base_Url = configuration["BASE_URL"]!;
            _httpClientFactory = httpClientFactory;
        }
        public async Task<string> GetJobIdAsync(string contentTypeId, string authToken, string operation, CancellationToken cancellationToken)
        {
            ...
            {
                Path = $"connections/{_connection_ID}/content-types/{contentTypeId}",
